...
if len(argv) == 2:
    if (argv[1] == '--help') or (argv[1] == '-h'):
        ...
        print('      -- 将目标文件中所有以"#~"开头且以".png", ".jpg", ".jpeg", ".svg", ".gif"结尾的行表达为markdown图片格式（注意图片末不能有空格，仅支持站内图片）')
        print('2. mdimginsert.py')
        print('      -- 输入目标文件路径，将其中以"#~"开头"#~"且以".png", ".jpg", ".jpeg", ".svg", ".gif"结尾的行表达为markdown图片格式（注意图片末不能有空格，仅支持站内图片）')
...
for i in range(len(content)):
    ...
    if flag:
        ...
        content[i] = '[![{0}](/img/{1})](/img/{1})'.format(content[i][:-1], imgname) + '\n'
