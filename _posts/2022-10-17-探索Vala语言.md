...
而在下一个版本中，Vala还计划为[ISO 646](http://www.cplusplus.com/reference/ciso646/)提供支持，从语法上带来更好的体验。笔者也于近期为Vala写了支持用下划线分隔数字以增强可读性的功能，该功能已经[提交PR](https://gitlab.gnome.org/GNOME/vala/-/merge_requests/263)，等待官方的审核与合并。该功能支持了对一下写法的支持：
```vala
int a = 123_456_789;
uint b = 1_000_0000;
