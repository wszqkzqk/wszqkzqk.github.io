...
笔者提交的[相关补丁](https://gitlab.gnome.org/GNOME/vala/-/merge_requests/296)已经得到合并，自Vala 0.58起，`string.replace`支持设置最大替换次数。
...
- [`string.replace`性能优化](https://gitlab.gnome.org/GNOME/vala/-/merge_requests/296)
