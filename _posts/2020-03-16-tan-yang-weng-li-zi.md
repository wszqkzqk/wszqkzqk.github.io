...
![碳氧𬭩离子的一般结构](/img/post-220px-Oxocarbenium-canonical_forms.webp)
...
![](/img/post-440px-C=Xelectrophilicity.webp)
...
![假想的五元氧碳𬭩离子过渡态](/img/post-5-membered.webp)
五元环反应所涉及的立体化学可以通过信封形过渡态模型来预测。 亲核试剂有利于从信封的“内部”或右侧图的顶部加成。从信封内部加成将产生有利的交错式构象，而从信封外加成则将产生能量不利的重叠式构象 。 [^2]

![](/img/post-450px-Woerpel_1999.webp)
### 六元环

![六元碳氧𬭩离子环的过渡态模型](/img/post-450px-6-membered.webp)
...
![](/img/post-500px-6-Membered_Oxocarbenium.webp)
### 立体电子效应
...
![](/img/post-500px-Sugarhydrolysis.webp)
## 参见
