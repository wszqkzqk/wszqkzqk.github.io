...
*   **短周期摄动**：这些摄动项与日、地、月三者的瞬时相对位置紧密相关，周期通常在一个月或一年左右。主要包括：
    *   **出差 (Evection)**：太阳引力引起的月球轨道偏心率最大周期性变化项。当近地点连线与太阳方向接近平行（朔望前后）时，出差与中心方程同向叠加，使有效偏心率达到极大；当两者接近垂直（上下弦前后）时，出差与中心方程反向抵消，使有效偏心率达到极小。这种效应导致月球在轨道上的实际位置与单纯椭圆运动产生显著偏差，周期约31.8天（近点月与朔望月的拍频周期，即两者相位滑移一周所需时间），振幅可达1.274°，是太阳摄动中对偏心率和近点经度影响最大的短周期项。
