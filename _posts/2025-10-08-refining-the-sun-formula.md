...
为什么不直接用 Meeus 算法？Meeus 虽优越（RMSD 0.0033°），但：
...
| 方法 | 整月平均 RMSD | 整月最差 RMSD | 最大绝对误差 |
|------|-----------|-----------|-----------|
| Meeus | 0.0033 | 0.0083 | 0.0122 |
| Fourier | 0.085 | 0.333 | 0.3372 |
| 原 Wikipedia | 0.124 | 0.417 | 0.4844 |
| 优化 Wikipedia | 0.076 | 0.27 | 0.2812 |
