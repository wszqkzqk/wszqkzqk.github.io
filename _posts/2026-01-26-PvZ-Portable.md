...
subtitle:     近乎100%复现植物大战僵尸年度版体验的开源引擎，支持Linux、Windows、macOS、Android、iOS/iPadOS等多平台
date:         2026-01-26
author:       wszqkzqk
...
| 🌿 原汁原味 | 🎮 可移植/跨平台 | 🛠️ 开源开放 |
| :---: | :---: | :---: |
| 几乎 100% 复刻原版所有特性 | 支持 Linux, Windows, macOS, Android, iOS/iPadOS, Switch... | 基于 OpenGL & SDL |
...
2.  **真正、全面跨平台**：
    *   **OS**: Linux, Windows, macOS, Android, iOS/iPadOS
        *   32 位和 64 位支持
