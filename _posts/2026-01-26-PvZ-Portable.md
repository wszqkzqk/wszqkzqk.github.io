...
subtitle:     近乎100%复现植物大战僵尸年度版体验的开源引擎，支持Linux、Windows、macOS、Android等多平台
date:         2026-01-26
author:       wszqkzqk
...
| 🌿 原汁原味 | 🎮 可移植/跨平台 | 🛠️ 开源开放 |
| :---: | :---: | :---: |
| 几乎 100% 复刻原版所有特性 | 支持 Linux, Windows, macOS, Android, Switch... | 基于 OpenGL & SDL |
...
Android 版使用 **Storage Access Framework（SAF）**，无需额外存储权限。存档数据与桌面版通用，详见[存档格式 v4](https://wszqkzqk.github.io/2026/01/30/PvZ-Portable-Save-Format-v4/)。更多 Android 适配的技术细节见 [Android 适配技术博客](https://wszqkzqk.github.io/2026/03/08/PvZ-Portable-Android-Adaptation/)。
