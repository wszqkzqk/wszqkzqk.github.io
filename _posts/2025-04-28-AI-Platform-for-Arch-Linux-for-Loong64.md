...
笔者实测发现，使用[Grok网页版](https://grok.com/)并选择Grok 4 Fast模型，将[本博客网站链接](https://wszqkzqk.github.io/)加到提示词中，模型即会自动检索并引用笔者博客中的内容来回答问题。此外，该模型在网页版中自带的网页搜索功能也比笔者实现的要强大得多。Grok默认即打开了强大的网页搜索功能，它不仅会自动生成搜索关键词查询，还会自动判断内容是否相关、资料是否充足且恰当。因此，除了笔者编写的Arch Linux for Loong64文档外，它还能很好地利用上更多的网络资源来回答问题，这往往能带来更好的效果。
