...
{\displaystyle k=\kappa {\frac {k_{B}T}{h}}e^{\frac {\Delta S^{\ddagger }}{R}}e^{\frac {-\Delta H^{\ddagger }}{RT}}}k = \kappa\frac{k_BT}{h}e^{\frac{\Delta S^{\Dagger }}{R}}e^{\frac{- \Delta H^{\Dagger }}{RT}}
TST的速率常数表达式可以用于计算Δ‡G⦵、Δ‡H⦵、Δ‡S⦵和甚至Δ‡V（用速率数据表达的（活化体积）。
