...
* [Loongarch新世界Mate GUI镜像下载: archlinux-kde-2023.01.30.1-loong64.iso](http://lauosc.cn:11232/iso/loong64/archlinux/archlinux-mate-2023.01.31.1-loong64.iso)
...
为了方便调试，可以编辑`/etc/mkinitcpio.conf`，去掉`GRUB_CMDLINE_LINUX_DEFAULT`的参数中的`quiet`。
