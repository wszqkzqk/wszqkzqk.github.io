...
![Murai反应 X=导向基团](/img/chem/directing-group/post-Figure_1._General_scheme_of_a_Murai_reaction.webp)

Murai反应与邻位定向金属化反应，该反应通常应用于取代的芳环的锂化 [^2] 。

![](/img/chem/directing-group/post-600px-Directedorthometalation.webp)
...
![通过2-氨基-3-甲基吡啶提供的可脱除性导向基活化CH键](/img/chem/directing-group/post-388px-JunTDG.webp)

本文采用[CC-BY-SA-4.0](https://creativecommons.org/licenses/by-sa/4.0/)协议发布，来自我创建的Wikipedia条目[导向基团](https://zh.wikipedia.org/wiki/%E5%AF%BC%E5%90%91%E5%9F%BA%E5%9B%A2)，由于个人水平限制，本条目难免会有知识谬误以及描述不清等情况，欢迎读者在维基条目中编辑修改或对本网站在[GitHub上的源代码](https://github.com/wszqkzqk/wszqkzqk.github.io)提供Pull request，也欢迎在评论区多多指教。
