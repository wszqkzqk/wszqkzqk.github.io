...
catalog:    true
tags:       系统配置 系统维护 开源软件 Linux archlinux 国产硬件 虚拟化 龙芯 LoongArchLinux 容器 QEMU
---
...
欢迎大家参与北京大学Linux俱乐部的[Loong Arch Linux移植工作](https://github.com/lcpu-club/loongarch-packages)！
