...
![](/img/chem/curtin-hammett/C-H原理平衡反应.svg)
...
![](/img/chem/curtin-hammett/650px-Curtin-Hammett_Principle_Diagram.webp)
...
![](/img/chem/curtin-hammett/C-H原理述图3.svg)  
由A生成C的速率方程如下:  
![](/img/chem/curtin-hammett/C-H原理述图4.svg)  
同样，由B生成D的速率方程为:  
![](/img/chem/curtin-hammett/C-H原理述图5.svg)  
其中 K 是AB相互转化的平衡常数. 那么它们的速率之比可以表示为:  
![](/img/chem/curtin-hammett/C-H原理述图6.svg)  
由于平衡转化速率相对于产物生成的速率要大, 反应物的比 [B]/[A]的值是平衡常数K，其在反应全过程中始终保持不变。因此，产物的比例可以写成:
![](/img/chem/curtin-hammett/C-H原理述图7.svg)  
如果反应物A和B处在相同的能量级别, 即Δ G = 0, 那么产物的比例将仅仅由各自的过渡态到产物的相对能量决定:
![](/img/chem/curtin-hammett/C-H原理述图8.svg)
...
![](/img/chem/curtin-hammett/C-H原理述图9.webp)
...
![](/img/chem/curtin-hammett/C-H原理述图10.webp)
...
![](/img/chem/curtin-hammett/C-H原理述图13.webp)
