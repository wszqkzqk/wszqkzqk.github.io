...
此外，Vala语言还具有跨平台的特性。Vala背靠完备的基础库GLib，强大的图形库GTK，高度集成的媒体库GStreamer，以及SDL2、ZLib、OpenGL等各种各样非GNOME库的语言绑定，还可以通过vapi进一步拓展。Vala既能用来开发高效率运行的CLI应用，又能用来开发功能丰富的GUI应用，适用场景较广。
