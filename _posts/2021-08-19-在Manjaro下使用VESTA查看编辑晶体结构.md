...
date:         2021-08-17
author:       wszqkzqk
header-img:   img/chem/vesta/vesta-bg.webp
catalog:      true
...
[![](/img/chem/vesta/vesta.webp)](https://jp-minerals.org/vesta/en)
...
[![](/img/chem/vesta/vesta-os-support.webp)](https://jp-minerals.org/vesta/en/download.html)
...
[![#~/img/chem/vesta/vesta-pkgbuild.webp](/img/chem/vesta/vesta-pkgbuild.webp)](/img/chem/vesta/vesta-pkgbuild.webp)
...
[![#~/img/chem/vesta/vesta-rpm-aur.webp](/img/chem/vesta/vesta-rpm-aur.webp)](/img/chem/vesta/vesta-rpm-aur.webp)
...
[![#~/img/chem/vesta/vesta-rpm-pamac.webp](/img/chem/vesta/vesta-rpm-pamac.webp)](/img/chem/vesta/vesta-rpm-pamac.webp)
...
[![#~/img/chem/vesta/vesta-rpm-install.webp](/img/chem/vesta/vesta-rpm-install.webp)](/img/chem/vesta/vesta-rpm-install.webp)

### 使用
#### 运行软件
直接运行VESTA的.desktop快捷方式或终端运行`VESTA`即可打开软件

[![#~/img/chem/vesta/vesta-application.webp](/img/chem/vesta/vesta-application.webp)](/img/chem/vesta/vesta-application.webp)
...
[![#~/img/chem/vesta/vesta-打开方式.webp](/img/chem/vesta/vesta-打开方式.webp)](/img/chem/vesta/vesta-打开方式.webp)
...
[![#~/img/chem/vesta/vesta-mime.webp](/img/chem/vesta/vesta-mime.webp)](/img/chem/vesta/vesta-mime.webp)

设置对应的类型名后点击确定

[![#~/img/chem/vesta/vesta-mime-2.webp](/img/chem/vesta/vesta-mime-2.webp)](/img/chem/vesta/vesta-mime-2.webp)

然后找到刚才添加的新文件类型，分别添加“文件名模式”（即对应的后缀名）并设置“程序优先顺序”（添加VESTA并设置在首位）

[![#~/img/chem/vesta/vesta-mime-3.webp](/img/chem/vesta/vesta-mime-3.webp)](/img/chem/vesta/vesta-mime-3.webp)

完成设置后即可在双击文件时自动采用VESTA打开

打开晶体文件后的示例：

[![#~/img/chem/vesta/vesta-YInMnBlue.webp](/img/chem/vesta/vesta-YInMnBlue.webp)](/img/chem/vesta/vesta-YInMnBlue.webp)
