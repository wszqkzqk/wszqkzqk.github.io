...
2. [新标准](https://developer.android.google.cn/img/media/platform/motion-photo-format)（MotionPhoto）：
...
<a href="https://github.com/wszqkzqk/live-photo-conv/">
  <img src="/img/media/live-photo-conv/live-photo-conv-logo.png" alt="Live Photo Converter" style="width: 500px; max-width: 100%;" />
</a>
...
目前笔者测试发现，至少**小米HyperOS 3**只需要必要的`XMP`元数据即可识别动态照片，不需要任何“私货”元数据，因此使用本工具生成的动态照片**无需上述处理**即可在小米的HyperOS 3上**正常识别**。其他厂商的情况仍需用户自行测试。
